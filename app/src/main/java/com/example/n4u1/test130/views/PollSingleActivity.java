...
public class PollSingleActivity extends AppCompatActivity {
    ...
    ImageView pollActivity_imageView_userAddContent_check_1;
...
//                        pollActivity_imageView_userAddContent_check_1.setVisibility(View.VISIBLE);
    ...
    public void checking_img_1() {
        pollActivity_imageView_userAddContent_1.setAlpha(0.3f);
        Glide.with(this)
                .load(R.drawable.ic_outline_check_24px)
                .into(pollActivity_imageView_userAddContent_check_1)
                .getView();
    }
}
